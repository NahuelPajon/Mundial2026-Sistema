...
public interface ISectorRepository
{
    ...
    Task<int> GetEntradasDisponiblesPorEventoAsync(int idEstadio, string codigo, int idEvento);
    Task<List<Sector>> GetHabilitadosPorEventoAsync(int idEstadio, int idEvento);
