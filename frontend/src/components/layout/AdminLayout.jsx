...
import { LayoutDashboard, Building2, Calendar, User, Bell, LogOut, Loader2 } from "lucide-react";
...
export default function AdminLayout({ children }) {
  ...
  const adminName = user && user.email 
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface font-body-md pb-32">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <button 
              ...
              className="w-10 h-10 rounded-full bg-primary-container border border-primary/20 flex items-center justify-center overflow-hidden focus:outline-none hover:border-primary/50 transition-colors"
            >
              <img 
                className="w-full h-full object-cover" 
                alt="Administrador" 
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAAcnjDHgMEXif6uJEZWK5oL5ojTuj9m24ikei-_PD5KSZWzFL0JnaN03w_C8YaeJD2yQNTlhvnZ41ZeVtpv0fSqhv9CrPSjQXZG7Hhebss1oeYucXL-fA2yFdRsWYNWEMNoqCsFEYrEMe377peI8k04PRwtkGJdZN9H306AAg55wlA3RBF02CYm2ThRmdV1PaWmYg96Y6OI-SmXj1raFh62283het1GZZTF4vsYaK7VPBY2b13EJ9h0Zr1E4IMuuQlN_CM8PecKz0W"
              />
            </button>
          ...
          <div className="flex flex-col text-left">
            <span className="font-label-bold text-[10px] leading-tight text-on-surface-variant">SEDE CENTRAL</span>
            <span className="font-headline-sm text-[14px] leading-tight text-white font-semibold">Panel Admin</span>
          </div>
        </div>

        <div className="flex items-center gap-4">
          <div className="hidden md:block">
            <h1 className="font-display-lg-mobile text-[16px] text-primary tracking-tighter uppercase font-bold">
              FIFA World Cup 2026
            </h1>
          </div>
      ...
      {/* Main Content */}
      <main className="pt-24 px-margin-mobile max-w-7xl mx-auto space-y-stack-md animate-in fade-in slide-in-from-bottom-4 duration-700">
        {children}
      </main>
